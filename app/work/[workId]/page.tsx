...
export default function WorkDetails(): ReactElement {
	...
	return (
		<div className="flex flex-col px-5 lg:px-20">
			<section className="flex flex-col pt-26 md:pt-32 border-b-1 border-[#0000001F] pb-[5dvh] md:pb-[10dvh]">
				<button
					onClick={(e) => {
						e.preventDefault();
						router.back();
			...
			<section className="flex flex-col md:flex-row border-b-1 border-[#0000001F] pb-[2dvh] md:pb-[3dvh] justify-between">
			...
			<section className="flex flex-col pt-[4dvh]">
				...
				<div className="flex flex-wrap pt-4 gap-x-[1dvw] gap-y-[0.6dvh] items-center">
